...
--
-- where @c@ is positive.
data ConwaySeq a = ConwaySeq
  { -- | The normalized base value of the sequence.
    csBase :: Conway a,
    -- | The sign of the varying part @True@ for plus or @False@ for minus.
    csSign :: Bool,
    -- | The varying part, which is a monomial sequence (@MonoSeq@).
    csTerm :: MonoSeq a
  }
  deriving (Eq)
